...
from custom_forms.models import FormType, FormTypeObject
...
class CustomModelForm(ModelFormWidget):
    ...
    def create_model_formfields(self):
        ...
        self.select_form.queryset = FormType.objects.filter(content_type=ctype)
    ...
    def show_edit_form(self, pk=None):
        ...
        ctype = ContentType.objects.get_for_model(self.model)
        formobj = FormTypeObject.objects.filter(content_type=ctype, object_id=pk).first()
